...
INSERT INTO `AUTHENTICATOR_CONFIG` VALUES ('5787b67f-15eb-4634-bf88-33d48a3e871f','review profile config','training-platform-realm'),('5d6aa9a5-2133-414e-91ee-91113325edf3','create unique user config','training-platform-realm'),('6c3fc3f6-8fb6-4857-9af7-22993fd89eec','review profile config','fdgdg'),('73810be0-76bc-4eb0-90bd-a0643ed9c9e6','create unique user config','master'),('b5884ce4-348d-4ad9-aa04-4c7ff43b2e06','create unique user config','fdgdg'),('c8080b28-a10f-4e3d-bda0-b3a00cc7ce15','review profile config','master');
