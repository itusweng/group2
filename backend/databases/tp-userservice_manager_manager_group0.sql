...
--
-- Table structure for table `manager_manager_group`
--

DROP TABLE IF EXISTS `manager_manager_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `manager_manager_group` (
...
-- Dump completed on 2022-01-08 22:27:30
