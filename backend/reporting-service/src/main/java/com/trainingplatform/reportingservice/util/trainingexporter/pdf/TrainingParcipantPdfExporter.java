...
public class TrainingParticipantPdfExporter extends ITrainingExporter {
    ...
    @Override
    public void exportTrainingParticipants(HttpServletResponse response, List<UserResponseDTO> participants, TrainingResponseDTO training) throws IOException {
    ...
    private void writeTableData(PdfPTable table) {
        participants.forEach(participant -> {
            ...
            table.addCell(participant.getRole_name());
        });
    }
}