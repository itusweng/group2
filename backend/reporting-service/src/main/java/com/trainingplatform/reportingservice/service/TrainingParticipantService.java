...
public class TrainingParticipantService {
    ...
    public List<TrainingParticipantResponseDTO> getTrainingParticipants(Long trainingId) {
        ...
        List<TrainingParticipantResponseDTO> participantList = new ArrayList<>();
        ...
        participantsResponse.forEach(
                participant -> participantList.add(objectMapper
                        ...
                        .convertValue(participant, TrainingParticipantResponseDTO.class)
                ));
